...
for _, row in df.iterrows():
    ...
    nro_oportunidad = clean(row["nro_oportunidad"])
    ...
    print("\n➡️ Param 1 (id):", repr(nuevo_id), type(nuevo_id))
    print("➡️ Param 2 (nro_oportunidad):", repr(nro_oportunidad), type(nro_oportunidad))
    print("➡️ Param 3 (nro_antiguo):", repr(nro_antiguo), type(nro_antiguo))
